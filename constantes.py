...
parser.add_argument("-rep", type=str, default="Results/", help="Répertoire d'enregistrement des résultats")
parser.add_argument("-rf", type=str, default="FitnessEvolution/",
                    help="Sous-répertoire d'enregistrement des scores de la fitness")
...
parser.add_argument("-d", type=int, default=9260,
                    help="Distance de séparation pour le conflit aérien, initialisée à 5NM (exprimée en m)")
...
parser.add_argument("-v", default=250,
                    help="Vitesse dans le cas d'avions ayant tous la même, liste de bornes [Min,Max] pour une répartition aléatoire des vitesses, initialisé à 250 m/s ")
...
parser.add_argument("-cr", type=float, default=0.05, help="Probabilité CR (Change Rate) de l'ED, initialisée à 0.05")
...
parser.add_argument("-st", type=int, default=0,
                    help="Configuration des vitesses: 0:constantes 1:pseudo-aléatoire (dans ce cas préciser obligatoirement une liste de bornes de vitesse)")
