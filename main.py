...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        t = time.time()
        v = cS.vitesseConstante(VITESSE)  # avoir la vitesse des avions (différentes si on choisit la situation aleatoire (mettre une liste de borne min et borne max)
        Flights = cS.hasard(VITESSE)
